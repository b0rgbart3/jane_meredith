...
<style>
    ...
    .bookImage {
        ...
        margin-left:auto;
        margin-right:auto;
        box-shadow:0px 0px 12px rgb(104, 12, 104);
        
    }
    .bookDescriptionSubTitle {
    padding:0;
    margin:0;
    font-weight: 600;
    font-size:.7em;
...
<p class='dividerTitle'>Books Authored by Jane Meredith</p>
<div class='bookContainer'>
    <table class='bookTable'>
        <tr>
            <td class='bookCell' valign="top">
                <div class='bookImageContainer'>
                    <img src='content/images/books/circle_of_eight.png' class='bookImage'>
                </div>
...
"Circle of Eight provides real, heartfelt, and practical methods of living our spirituality, of reminding us what our Paganism truly means, while keeping open and inspired by the lessons around us."―Cat Treadwell, Druid priest and author of Facing the Darkness and A Druid's Tale -->
            ...
            <td class='bookCell' valign="top">
                <div class='bookImageContainer'>
                    <img src='content/images/books/rituals_of_celebration.png' class='bookImage'>
                </div>
